                ...
                <div className="relative hidden lg:flex lg:w-1/2 min-h-screen items-center justify-center bg-black overflow-hidden">
                    ...
                    <div className="relative z-10 p-12 text-white text-center animate-slideUp">
                        <div className="mb-8 animate-bounce-slow">
                            <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full mb-4 shadow-lg shadow-yellow-500/30">
                                <span className="text-6xl">👑</span>
                            </div>
                        </div>
                        <h1 className="text-5xl font-bold mb-6 tracking-tight">
                            Admin <span className="gradient-text-accent">Access</span>
                        </h1>
